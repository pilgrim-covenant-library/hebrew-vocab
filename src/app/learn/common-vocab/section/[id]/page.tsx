...
export default function CommonVocabSectionPage() {
  ...
  const rawId = typeof params?.id === 'string' ? params.id : Array.isArray(params?.id) ? params.id[0] : '1';
  ...
  const sectionMeta = COMMON_VOCAB_SECTION_META[sectionId] || {
    ...
    description: `Words ${(sectionId - 1) * WORDS_PER_SECTION + 1}–${sectionId * WORDS_PER_SECTION}`,
  };
        ...
        {currentQuestion && (
          <Card className="w-full max-w-md mb-6 overflow-hidden">
            ...
            <CardContent className="py-8">
              ...
              <HebrewWord
                hebrew={currentQuestion.word.hebrew}
              ...
              <div className="flex justify-center items-center gap-2 mt-2">
                <span className="px-2 py-1 rounded-full text-xs font-medium bg-amber-100 text-amber-700 dark:bg-amber-900 dark:text-amber-300">
                  {currentQuestion.word.frequency.toLocaleString()}x in OT
                </span>
...
function LoadingSkeleton() {
  return (
    <div className="min-h-screen flex flex-col animate-pulse bg-background">
