      ...
      <CardContent className="space-y-4">
        ...
        {relations.relatedRoot.length > 0 && (
          <RelationSection
            ...
            onWordClick={onWordClick}
            description="Words from similar Hebrew roots"
          />
        )}
        ...
        <div className="flex flex-wrap gap-1.5">
          {words.map((w) => (
            <button
              ...
              className="px-2 py-1 text-xs rounded-md bg-muted hover:bg-muted/80 transition-colors font-hebrew"
              dir="rtl"
            >
              {w.hebrew}
            </button>
        ...
        {words.map((w) => (
          ...
          >
            <div className="flex items-center gap-3">
              <span className="font-hebrew text-lg" dir="rtl">{w.hebrew}</span>
