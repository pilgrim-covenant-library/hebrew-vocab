...
const helpLinks: HelpLink[] = [
  {
    ...
    description: 'Hebrew alphabet to Latin letters',
  ...
  {
    href: '/homework/help/construct-state',
    label: 'Construct State',
    description: 'Hebrew noun relationships',
    icon: <FileText className="w-4 h-4" />,
  },
  {
    href: '/homework/help/binyanim',
    label: 'Binyanim (Verb Stems)',
    description: 'The seven Hebrew verb stems',
...
const sectionHelpMap: Record<SectionId, string[]> = {
  ...
  4: ['/homework/help/construct-state'],
  5: ['/homework/help/binyanim'],
};
