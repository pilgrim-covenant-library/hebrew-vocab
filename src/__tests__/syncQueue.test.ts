...
describe('Sync Queue', () => {
  ...
  describe('processQueue', () => {
    ...
    it('should respect max retries', async () => {
      ...
      // Should try 5 times total (maxRetries = 5)
  ...
  describe('Persistence', () => {
    it('should save queue to localStorage', () => {
      ...
      const stored = localStorage.getItem('hebrew_sync_queue_metadata');
    ...
    it('should handle corrupted localStorage data', () => {
      localStorage.setItem('hebrew_sync_queue_metadata', 'invalid json');
  ...
  describe('clearQueue', () => {
    ...
    it('should clear localStorage', () => {
      ...
      expect(localStorage.getItem('hebrew_sync_queue_metadata')).not.toBeNull();
  ...
  describe('forceSync', () => {
    it('should return true when queue is empty', async () => {
      const result = await syncQueue.forceSync();

      expect(result).toBe(true);
    });

    it('should process and return success when all operations complete', async () => {
      const operation = jest.fn(async () => {});
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle operations that throw synchronously', async () => {
      ...
      expect(() => {
        syncQueue.add(badOperation as unknown as () => Promise<void>, 'progress');
      }).not.toThrow();
    });
