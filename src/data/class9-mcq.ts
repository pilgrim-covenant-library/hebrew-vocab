...
//
// Released: routes to /class-practice/class-9-mcq with hub card on /class-practice.
...
const ch24Questions: PracticeQuestion[] = [
  ...
  { id: 'class9-ch24-2', prompt: 'Why are some Niphal verbs translated with an ACTIVE voice?', options: ['because the Niphal is fundamentally an active stem', 'because their roots are unattested in the Qal', 'because the translators disagree', 'because they are always reflexive'], correctIndex: 1, explanation: 'לָחַם is a good example: it is rare in the Qal, so the Niphal נִלְחַם simply means "he fought." Check the lexicon before forcing a passive.', category: 'ch24' },
...
const ch24MemoryQuestions: PracticeQuestion[] = [
  { id: 'class9-memory-ch24-perfect', prompt: 'Parse this form.', hebrew: 'נִקְטַל', transliteration: 'niqtal', options: ['Niphal Perfect 3ms', 'Niphal Imperfect 3ms', 'Qal Perfect 3ms', 'Niphal Imperative'], correctIndex: 0, explanation: 'A visible נ prefix plus a Pathach stem vowel marks the Niphal Perfect. The Participle נִקְטָל looks almost identical — it has Qamets instead.', category: 'ch24-memory' },
  { id: 'class9-memory-ch24-imperfect', prompt: 'Parse this form.', hebrew: 'יִקָּטֵל', transliteration: 'yiqqatel', options: ['Qal Imperfect 3ms', 'Niphal Imperfect 3ms', 'Niphal Perfect 3ms', 'Hiphil Imperfect 3ms'], correctIndex: 1, explanation: 'The Daghesh Forte in the first root consonant is an assimilated נ, and the Tsere stem vowel completes the Niphal Imperfect pattern.', category: 'ch24-memory' },
  { id: 'class9-memory-ch24-participle', prompt: 'Parse this form.', hebrew: 'נִקְטָל', transliteration: 'niqtal', options: ['Niphal Imperfect', 'Niphal Infinitive Construct', 'Niphal Participle ms', 'Qal passive participle'], correctIndex: 2, explanation: 'The Niphal Participle keeps the visible נ but takes a QAMETS stem vowel, where the Perfect has Pathach. That one vowel is the whole difference.', category: 'ch24-memory' },
  { id: 'class9-memory-ch24-imperative', prompt: 'Parse this form.', hebrew: 'הִקָּטֵל', transliteration: 'hiqqatel', options: ['Qal Imperative', 'Hiphil Perfect', 'Niphal Perfect', 'Niphal Imperative'], correctIndex: 3, explanation: 'Where the נ assimilates, a ה prefix appears to support the doubled consonant: הִקָּטֵל serves as both Imperative and Infinitive Construct.', category: 'ch24-memory' },
  ...
  { id: 'class9-memory-ch24-nilcham', prompt: 'How should נִלְחַם be translated?', hebrew: 'נִלְחַם', transliteration: 'nilcham', options: ['"he was fought against"', '"he fought"', '"he caused fighting"', '"let him fight"'], correctIndex: 1, explanation: 'A Niphal form does not guarantee a passive translation. When a root lives mainly in the Niphal, the stem simply carries the plain meaning.', category: 'ch24-memory' },
];
...
const ch25Questions: PracticeQuestion[] = [
  ...
  { id: 'class9-ch25-3', prompt: 'In III-ה Niphal verbs, what is affected?', options: ['the endings across each conjugation, while stem prefixes remain intact', 'every form is completely reshaped', 'only the Imperfect', 'none — the class is identical to the strong verb'], correctIndex: 0, explanation: 'The III-ה endings you have met in the Qal (e.g. ־ָה in Perfect, ־ֶה in Imperfect, ־וֹת in Infinitive Construct) reappear across each conjugation, while the Niphal prefix diagnostics remain intact.', category: 'ch25' },
  ...
  { id: 'class9-ch25-5', prompt: 'Why do I-guttural roots look so different in the Niphal?', options: ['because the stem נ is dropped', 'because gutturals reject a simple Shewa and take reduced vowels instead', 'because the root gains a fourth letter', 'because the stem vowel becomes a Shureq'], correctIndex: 1, explanation: 'The changes look drastic at first but are entirely predictable: נֶאֱמַן shows the Seghol and Hateph Seghol that a guttural forces.', category: 'ch25' },
...
const ch25MemoryQuestions: PracticeQuestion[] = [
  { id: 'class9-memory-ch25-nimtsa', prompt: 'Which root would you look up for this Niphal form?', hebrew: 'נִמְצָא', transliteration: 'nimtsa', options: ['מָצָא ("to find")', 'נָצַל ("to deliver")', 'מָלַט ("to escape")', 'נָצַב ("to stand")'], correctIndex: 0, explanation: 'Strip the נ stem prefix and you are left with the root מצא. Take care not to mistake the stem נ for a root letter.', category: 'ch25-memory' },
  { id: 'class9-memory-ch25-nivnah', prompt: 'Which root would you look up for this Niphal form?', hebrew: 'נִבְנָה', transliteration: 'nivnah', options: ['נָבָא ("to prophesy")', 'בָּנָה ("to build")', 'בִּין ("to understand")', 'בָּחַר ("to choose")'], correctIndex: 1, explanation: 'The prefixed נ is the stem marker; the Qamets-He ending is the III-ה diagnostic that recurs in every derived stem.', category: 'ch25-memory' },
  { id: 'class9-memory-ch25-nosha', prompt: 'Which root would you look up for this Niphal form?', hebrew: 'נוֹשַׁע', transliteration: 'nosha', options: ['נָשָׂא ("to lift")', 'שׁוּב ("to return")', 'יָשַׁע ("to save, deliver")', 'נָשַׁק ("to kiss")'], correctIndex: 2, explanation: 'I-י roots (originally I-ו) show a Holem Waw in the Niphal Perfect: נוֹשַׁע = "he was saved" — יִשְׂרָאֵל נוֹשַׁע בַּיהוָה (Isa 45:17).', category: 'ch25-memory' },
  { id: 'class9-memory-ch25-niglah', prompt: 'Which root would you look up for this Niphal form?', hebrew: 'נִגְלָה', transliteration: 'niglah', options: ['נָגַשׁ ("to draw near")', 'נָגַד ("to tell")', 'גָּדַל ("to be great")', 'גָּלָה ("to uncover, reveal")'], correctIndex: 3, explanation: 'נִגְלָה = "it was revealed," as in "and the glory of the LORD shall be revealed" (Isa 40:5). גָּלָה is Chapter 17 vocabulary.', category: 'ch25-memory' },
  { id: 'class9-memory-ch25-neeman', prompt: 'Parse this form.', hebrew: 'נֶאֱמָן', transliteration: 'neeman', options: ['a Niphal participle', 'a Qal Perfect 3ms', 'a Hiphil Perfect 3ms', 'a Piel participle'], correctIndex: 0, explanation: 'The guttural א forces the Seghol and Hateph Seghol, but the visible נ prefix and the Qamets stem vowel still mark it as a Niphal participle.', category: 'ch25-memory' },
...
export const CLASS9_WORD_GROUPS: PracticeQuestionGroup[] = [
  ...
  wordGroup({ id: 'class9-word-aman', hebrew: 'אָמַן', transliteration: 'aman', transliterationOptions: ['amar', 'asaf', 'aman', 'asar'], transliterationCorrectIndex: 2, meaning: 'to be faithful, reliable; to believe, trust', meaningOptions: ['to say', 'to gather', 'to be faithful, reliable; to believe, trust', 'to bind'], meaningCorrectIndex: 2 }),
  wordGroup({ id: 'class9-word-yasha', hebrew: 'יָשַׁע', transliteration: 'yasha', transliterationOptions: ['yashav', 'yatar', 'yalad', 'yasha'], transliterationCorrectIndex: 3, meaning: 'to be delivered; to save, deliver, help', meaningOptions: ['to sit', 'to be left over', 'to give birth', 'to be delivered; to save, deliver, help'], meaningCorrectIndex: 3 }),
  ...
  wordGroup({ id: 'class9-word-malat', hebrew: 'מָלַט', transliteration: 'malat', transliterationOptions: ['mahar', 'malat', 'maas', 'makhar'], transliterationCorrectIndex: 1, meaning: 'to escape, slip away, be delivered', meaningOptions: ['to hasten', 'to escape, slip away, be delivered', 'to reject', 'to sell'], meaningCorrectIndex: 1 }),
  wordGroup({ id: 'class9-word-natsal', hebrew: 'נָצַל', transliteration: 'natsal', transliterationOptions: ['natsav', 'nakhah', 'natsal', 'nacham'], transliterationCorrectIndex: 2, meaning: 'to be rescued; to deliver, snatch away', meaningOptions: ['to stand firm', 'to strike', 'to be rescued; to deliver, snatch away', 'to be sorry, comfort'], meaningCorrectIndex: 2 }),
  wordGroup({ id: 'class9-word-nacham', hebrew: 'נָחַם', transliteration: 'nacham', transliterationOptions: ['natsal', 'natsav', 'nakhah', 'nacham'], transliterationCorrectIndex: 3, meaning: 'to be sorry, have compassion; to comfort', meaningOptions: ['to be rescued', 'to stand firm', 'to strike', 'to be sorry, have compassion; to comfort'], meaningCorrectIndex: 3 }),
...
const verseQuestions: PracticeQuestion[] = [
  ...
  { id: 'class9-verse-4', prompt: 'Translate this question (Genesis 18:14).', hebrew: 'הֲיִפָּלֵא מֵיהוָה דָּבָר', options: ['The LORD has done a wonderful thing.', 'Who can do wonders like the LORD?', 'A word went out from the LORD.', 'Is anything too wonderful for the LORD?'], correctIndex: 3, explanation: 'יִפָּלֵא is a III-א Niphal Imperfect (Ch 25, preserving strong-verb Imperfect diagnostics) with the interrogative הֲ in front (Ch 8). מִן here means "for / too ... for."', category: 'verse' },
  ...
  { id: 'class9-verse-6', prompt: 'Translate this warning (Deuteronomy 4:9).', hebrew: 'רַק הִשָּׁמֶר לְךָ וּשְׁמֹר נַפְשְׁךָ מְאֹד', options: ['He guarded himself and kept his soul.', 'Only take care, and keep your soul diligently.', 'Your soul will be kept and guarded.', 'Who will guard your soul?'], correctIndex: 1, explanation: 'Two Imperatives from one root: הִשָּׁמֶר is the Niphal ("watch yourself," Ch 24) and שְׁמֹר the Qal ("keep," Ch 18). The Niphal here is reflexive.', category: 'verse' },
];
...
const chapter24ContextQuestions: PracticeQuestion[] = [
  ...
  { id: 'class9-context-ch24-ps22-5', prompt: 'Translate this clause (Psalm 22:5 [MT 22:6]).', hebrew: 'אֵלֶיךָ זָעֲקוּ וְנִמְלָטוּ', options: ['They cried out and he rescued them.', 'To you they cried out and were delivered.', 'Cry out to him and be delivered!', 'They will cry to you and escape.'], correctIndex: 1, explanation: 'Chapter 24 focus: נִמְלָטוּ is a Niphal Perfect 3cp of מָלַט (Ch 24 vocabulary) with passive force, paired with the Qal זָעֲקוּ.', category: 'context-ch24' },
  ...
  { id: 'class9-context-ch24-gen2-23', prompt: 'Translate this clause (Genesis 2:23).', hebrew: 'לְזֹאת יִקָּרֵא אִשָּׁה', options: ['She called this one Woman.', 'This one will call to the woman.', 'Let her call this one Woman.', 'This one shall be called Woman.'], correctIndex: 3, explanation: 'Chapter 24 focus: יִקָּרֵא is a Niphal Imperfect with passive force ("shall be called"), preserving the strong-verb Imperfect pattern in a III-א root. The Daghesh Forte in the ק recovers the assimilated stem נ.', category: 'context-ch24' },
];
