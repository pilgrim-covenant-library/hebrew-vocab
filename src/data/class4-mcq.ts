...
const suffixMemoryQuestions: PracticeQuestion[] = [
  { id: 'class4-memory-suff-2fs', prompt: 'Translate this suffixed noun (2fs).', hebrew: 'סוּסֵךְ', transliteration: 'susekh', options: ['his horse', 'our horse', 'your horse (speaking to one woman)', 'their horse'], correctIndex: 2, explanation: 'סוּסֵךְ = "your horse" when speaking to one woman. The 2fs Type 1 suffix is ־ֵךְ.', category: 'suffix-memory' },
  ...
  { id: 'class4-memory-suff-2mp', prompt: 'Translate this suffixed noun (2mp).', hebrew: 'סוּסְכֶם', transliteration: 'suskhem', options: ['their horse', 'your horse (addressing a masculine or mixed group)', 'our horse', 'his horses'], correctIndex: 1, explanation: 'סוּסְכֶם = "your horse" when addressing a masculine or mixed group. The 2mp Type 1 suffix is ־ְכֶם.', category: 'suffix-memory' },
  ...
  { id: 'class4-memory-suff-3mp', prompt: 'Translate this suffixed noun (3mp).', hebrew: 'סוּסָם', transliteration: 'susam', options: ['our horse', 'your horse', 'their horse (masculine or mixed)', 'their horses (feminine)'], correctIndex: 2, explanation: 'סוּסָם = "their horse" for a masculine or mixed antecedent. The 3mp Type 1 suffix is ־ָם.', category: 'suffix-memory' },
