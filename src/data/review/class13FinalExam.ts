...
const class13ExamGrammarReplacements: PracticeMCQ[] = [
  ...
  { id: 'c13-fe-g03', question: 'In which Niphal conjugations does the stem נ appear as a full CONSONANT?', options: ['the Perfect, the Participle, and the Infinitive Absolute נִקְטוֹל', 'the Imperfect and the Imperative', 'the Infinitive Construct only', 'nowhere'], correctIndex: 0, explanation: 'Ch 24. Everywhere else it assimilates into the first root consonant and survives only as a Daghesh Forte.' },
  ...
  { id: 'c13-fe-g05', question: 'What is the characteristic Hiphil STEM vowel?', hebrew: 'הִקְטִיל', options: ['Qamets throughout', 'Hireq Yod or Tsere — except in the 1st and 2nd person Perfect, where it is Pathach', 'Shureq throughout', 'Qibbuts throughout'], correctIndex: 1, explanation: 'Ch 26. הִקְטִיל, יַקְטִיל and מַקְטִיל all show the Hireq Yod; הַקְטֵל shows the Tsere; הִקְטַלְתָּ shows the Pathach.' },
  { id: 'c13-fe-g06', question: 'Which root would you look up for the Hiphil form הוֹשִׁיעַ?', hebrew: 'הוֹשִׁיעַ', options: ['שׁוּב ("to return")', 'שָׁמַע ("to hear")', 'נָשָׂא ("to lift")', 'יָשַׁע ("to save") — a I-י verb'], correctIndex: 3, explanation: 'Ch 27. The Holem Waw after the ה prefix is the I-י Hiphil diagnostic, shared with הוֹצִיא and הוֹדִיעַ.' },
  ...
  { id: 'c13-fe-g08', question: 'Which three features are the Piel diagnostics?', options: ['a ה prefix, a Hireq Yod, and a Pathach', 'a Daghesh Forte in the second root consonant, Pathach under the first (except in the Perfect), and Shewa under Imperfect preformatives', 'a נ prefix, a Qamets, and a Tsere', 'a Shureq prefix vowel and a Pathach stem vowel'], correctIndex: 1, explanation: 'Ch 30. Learn those three and the whole Piel becomes readable, with II-Guttural roots as the single recurring exception.' },
