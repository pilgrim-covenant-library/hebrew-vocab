...
export const grammarQuestions: PracticeMCQ[] = [
  ...
  { id: 'pp-g02', question: 'Parse אֱלֹהִים in Genesis 1:1:', hebrew: 'בָּרָא אֱלֹהִים', options: ['Masculine singular', 'Feminine singular', 'Masculine plural form with singular verb', 'Masculine plural construct'], correctIndex: 2, explanation: 'אֱלֹהִים has masc plural ending (-îm) but takes singular verb בָּרָא — a "plural of majesty." It is the standard word for the one true God in the OT.' },
  { id: 'pp-g03', question: 'Parse הַשָּׁמַיִם in Genesis 1:1:', hebrew: 'אֵת הַשָּׁמַיִם', options: ['Article + masc sg', 'Article + masc pl', 'Article + dual', 'Article + fem pl'], correctIndex: 1, explanation: 'הַ (article, with dagesh in ש) + שָׁמַיִם ("heavens"): a masculine plural noun — the -ayim ending looks dual, but שָׁמַיִם is plural in form and meaning. The article + dagesh combination is the article\'s "fingerprint."' },
  { id: 'pp-g04', question: 'Parse הָאָרֶץ in Genesis 1:1:', hebrew: 'וְאֵת הָאָרֶץ', options: ['Article הַ + masc sg', 'Article הָ + fem sg', 'Construct + fem sg', 'Conjunction + fem sg'], correctIndex: 1, explanation: 'הָ (qamets) + אָרֶץ. Because א is a guttural and cannot take dagesh, the article LENGTHENS its vowel from pataḥ to qamets. אָרֶץ is feminine.' },
  ...
  { id: 'pp-g09', question: 'In construct chains, definiteness is shown by:', options: ['Article on the construct noun', 'Article on the absolute noun', 'Article on both nouns', 'Article on neither noun'], correctIndex: 1, explanation: 'Construct chain rule: the article on the ABSOLUTE noun makes the entire chain definite. דְּבַר הַמֶּלֶךְ = "the word of the king" (both definite). Never put הַ on the construct itself.' },
  ...
  { id: 'pp-g12', question: 'Parse לָאוֹר in Genesis 1:5:', hebrew: 'וַיִּקְרָא אֱלֹהִים לָאוֹר יוֹם', options: ['לְ + absorbed article', 'לְ + indefinite noun', 'Conjunction + noun', 'Construct chain'], correctIndex: 0, explanation: 'לָ = לְ + הָ (article absorbed; ה elides, vowel transfers). "to the light." The qamets under ל is the giveaway that the article is hiding.' },
  { id: 'pp-g13', question: 'Parse עַל in Genesis 1:2:', hebrew: 'וְחֹשֶׁךְ עַל־פְּנֵי תְהוֹם', options: ['Inseparable preposition', 'Independent preposition', 'Conjunction', 'Particle'], correctIndex: 1, explanation: 'עַל = "on/upon/over," an INDEPENDENT (not inseparable) preposition. Often connected with maqqef (־) to the next word. Used here for "over the surface of the deep."' },
  ...
  { id: 'pp-g15', question: 'Parse בֵּין in Genesis 1:4:', hebrew: 'וַיַּבְדֵּל אֱלֹהִים בֵּין הָאוֹר וּבֵין הַחֹשֶׁךְ', options: ['Conjunction', 'Independent preposition', 'Verb form', 'Article variant'], correctIndex: 1, explanation: 'בֵּין = "between." Used twice in this clause — "between X and between Y" — typical Hebrew idiom for "between X and Y."' },

  // --- Conjunctions & Particles ---
  { id: 'pp-g16', question: 'Parse the וְ in וְהָאָרֶץ (Gen 1:2):', options: ['Disjunctive vav', 'Vav-consecutive', 'Definite article', 'Preposition'], correctIndex: 0, explanation: 'A clause-initial וְ + NOUN (not a verb) introduces a DISJUNCTIVE clause: "now the earth..." or "and the earth..." It signals background/setting, not narrative advance.' },
  { id: 'pp-g17', question: 'Parse וַ in וַיֹּאמֶר (Gen 1:3):', hebrew: 'וַיֹּאמֶר אֱלֹהִים', options: ['Conjunctive vav', 'Vav-consecutive imperfect (wayyiqtol)', 'Vav-consecutive perfect', 'Disjunctive vav'], correctIndex: 1, explanation: 'וַ + dagesh in the prefix consonant + imperfect = WAYYIQTOL = narrative past. וַיֹּאמֶר = "and he said." This is the most frequent verb form in OT narrative.' },
  ...
  { id: 'pp-g20', question: 'Parse כִּי in Genesis 1:4:', hebrew: 'וַיַּרְא אֱלֹהִים אֶת־הָאוֹר כִּי־טוֹב', options: ['Causal or content conjunction', 'Negative particle', 'Definite article', 'Verb form'], correctIndex: 0, explanation: 'כִּי = "because, that" — frequent conjunction. Here it introduces what God saw: "saw the light, that it was good."' },
  ...
  { id: 'pp-g30', question: 'Parse יְהִי in Genesis 1:3:', hebrew: 'יְהִי אוֹר', options: ['Qal imperfect 3ms', 'Qal jussive 3ms', 'Qal participle ms', 'Niphal imperfect 3ms'], correctIndex: 1, explanation: 'יְהִי = jussive (a shortened imperfect expressing wish/command) of הָיָה: "let there be." The volitive force makes it the divine fiat: "Let there be light!"' },
  { id: 'pp-g31', question: 'Parse וַיְהִי in Genesis 1:3:', hebrew: 'וַיְהִי אוֹר', options: ['Qal imperfect 3ms', 'Qal wayyiqtol 3ms', 'Qal jussive 3ms', 'Hiphil perfect 3ms'], correctIndex: 1, explanation: 'וַיְהִי = wayyiqtol of הָיָה: "and there was." This is the narrative form — "and so it was." Compare with יְהִי (jussive: "let there be").' },
  { id: 'pp-g32', question: 'Parse וַיֹּאמֶר in Genesis 1:3:', hebrew: 'וַיֹּאמֶר אֱלֹהִים', options: ['Qal perfect 3ms', 'Qal imperfect 3ms', 'Qal wayyiqtol 3ms', 'Piel perfect 3ms'], correctIndex: 2, explanation: 'וַיֹּאמֶר = wayyiqtol of אָמַר ("say"). וַ + dagesh in next consonant + shortened imperfect = "and he said." The standard narrative verb in the OT.' },
  { id: 'pp-g33', question: 'Parse וַיַּרְא in Genesis 1:4:', hebrew: 'וַיַּרְא אֱלֹהִים אֶת־הָאוֹר', options: ['Qal perfect 3ms', 'Qal wayyiqtol 3ms', 'Niphal perfect 3ms', 'Hiphil imperfect 3ms'], correctIndex: 1, explanation: 'וַיַּרְא = wayyiqtol 3ms of רָאָה ("see"). Apocopated form (final ה drops in jussive/wayyiqtol). "And he saw."' },
  { id: 'pp-g34', question: 'Parse וַיִּקְרָא in Genesis 1:5:', hebrew: 'וַיִּקְרָא אֱלֹהִים לָאוֹר יוֹם', options: ['Qal wayyiqtol 3ms', 'Niphal perfect 3ms', 'Qal participle ms', 'Pual perfect 3ms'], correctIndex: 0, explanation: 'וַיִּקְרָא = qal wayyiqtol 3ms of קָרָא ("call"). With dagesh in י after וַ. Narrative past: "and he called." Genesis 1:5 names day and night.' },
  ...
  { id: 'pp-g36', question: 'Parse וַיַּבְדֵּל in Genesis 1:4:', hebrew: 'וַיַּבְדֵּל אֱלֹהִים בֵּין הָאוֹר', options: ['Qal wayyiqtol 3ms', 'Hiphil wayyiqtol 3ms', 'Niphal wayyiqtol 3ms', 'Piel wayyiqtol 3ms'], correctIndex: 1, explanation: 'וַיַּבְדֵּל = HIPHIL wayyiqtol of בָּדַל ("separate"). Hiphil signs: ַ + dagesh on prefix consonant after וַ; tsere-yod or tsere in the stem. Causative: "caused to divide / separated."' },
  ...
  { id: 'pp-g38', question: 'What is the recognition mark of the HIPHIL binyan?', options: ['Prefix ה- with hi-…-i pattern', 'Doubled middle consonant', 'No prefix', 'Suffix -ָה'], correctIndex: 0, explanation: 'HIPHIL: ה- prefix in perfect (הִקְטִיל), causative meaning ("make/cause to X"). Example: הִמְלִיךְ ("he made [X] king") from מֶלֶךְ.' },
  { id: 'pp-g39', question: 'What is the recognition mark of the NIPHAL binyan?', options: ['Prefix נ- in the perfect', 'Doubled middle root consonant', 'Prefix ה- in the perfect', 'Suffix -וּ'], correctIndex: 0, explanation: 'NIPHAL: נ- prefix in perfect (נִקְטַל); in imperfect, the נ assimilates and the prefix is hi- with dagesh (יִקָּטֵל). PASSIVE or REFLEXIVE meaning.' },
  { id: 'pp-g40', question: 'Identify HITHPAEL recognition marks:', options: ['Prefix הִתְ- with doubled middle root', 'Prefix נ- with doubled middle root', 'No prefix with doubled middle root', 'Suffix -וּ with doubled middle root'], correctIndex: 0, explanation: 'HITHPAEL: הִתְ- prefix + dagesh in middle root letter. REFLEXIVE/RECIPROCAL meaning. Example: הִתְפַּלֵּל ("he prayed" / "he made himself entreat").' },
  ...
  { id: 'pp-g45', question: 'How does Hebrew express "X has Y" (possession)?', options: ['Verb meaning "to have"', 'יֵשׁ + לְ + possessor', 'Special suffix on the verb', 'Genitive case ending'], correctIndex: 1, explanation: 'Hebrew has NO verb "to have." Construction: יֵשׁ ("there is") + לְ + possessor + thing. יֵשׁ לִי בַּיִת = "I have a house" (lit. "there is to me a house"). Negative: אֵין לִי. Past: הָיָה לִי.' },
  ...
  { id: 'pp-g47', question: 'Predicative adjective: "the man is good" =', options: ['הָאִישׁ הַטּוֹב', 'הַטּוֹב הָאִישׁ', 'טוֹב הָאִישׁ', 'הָאִישׁ טוֹב הוּא'], correctIndex: 2, explanation: 'PREDICATIVE: adjective LACKS the article even when the noun has it. טוֹב הָאִישׁ = "the man is good" (asserting). Both having articles = ATTRIBUTIVE = "the good man" (= הָאִישׁ הַטּוֹב, describing).' },
  { id: 'pp-g48', question: 'Hebrew verbal sequence: וַיֹּאמֶר ... וַיֹּאמֶר represents:', options: ['Two simultaneous events', 'Sequential narrative', 'Disjunctive contrast', 'Hypothetical condition'], correctIndex: 1, explanation: 'Wayyiqtol chains express SEQUENTIAL narrative — each verb advances the story. The vav-consecutive turns each form into "and then..."' },
  { id: 'pp-g49', question: 'When וְ is followed by a NOUN (instead of a wayyiqtol), the clause is:', options: ['Poetic sequence', 'Disjunctive clause', 'Subjunctive clause', 'Interrogative clause'], correctIndex: 1, explanation: 'A clause-initial וְ + non-verb signals a DISJUNCTIVE clause. Often pauses the narrative for background, contrast, or scene-setting. Example: Gen 1:2 וְהָאָרֶץ הָיְתָה — "now the earth was..."' },
...
export const vocabQuestions: PracticeMCQ[] = [
  ...
  { id: 'pp-v04', question: 'What does שָׁמַיִם mean?', options: ['light', 'water', 'heavens', 'earth'], correctIndex: 2, explanation: 'שָׁמַיִם = "heavens, sky." A plurale tantum — always plural, with the -ayim ending. Refers to the celestial realm.' },
...
export const verseAnalysisQuestions: PracticeVerseAnalysis[] = [
  {
    ...
    matchingPairs: [
      ...
      { hebrew: 'הַשָּׁמַיִם', category: 'Article + masculine plural noun' },
