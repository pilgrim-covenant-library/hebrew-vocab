...
export const class13VocabQuestions: PracticeMCQ[] = [
  ...
  {
    id: 'c13-v04',
    question: 'What does the noun אָב mean?',
    hebrew: 'אָב',
    options: ['son, descendant', 'father, ancestor', 'brother, kinsman', 'servant, slave'],
    correctIndex: 1,
    explanation: 'אָב means "father" and, in the plural אָבוֹת, "ancestors, forefathers". The construct singular אֲבִי appears in many names.',
  },
  {
    id: 'c13-v05',
  ...
  {
    id: 'c13-v07',
    question: 'What does the verb עָלָה mean?',
    hebrew: 'עָלָה',
    options: ['to go down, descend', 'to go up, ascend', 'to cross over, pass', 'to turn aside, depart'],
    correctIndex: 1,
    explanation: 'עָלָה ("to go up, ascend") is used of pilgrimage to Jerusalem and of offerings rising on the altar — hence the noun עֹלָה, the burnt offering that goes up.',
  },
  {
    id: 'c13-v08',
  ...
  {
    id: 'c13-v16',
    question: 'What does the noun אֹיֵב mean?',
    hebrew: 'אֹיֵב',
    options: ['witness, accuser', 'stranger, sojourner', 'neighbour, companion', 'enemy, foe'],
    correctIndex: 3,
    explanation: 'אֹיֵב ("enemy, foe") is a Qal participle used as a noun — literally "one hating" — and is the standard word for a national or personal adversary.',
  },
  {
    id: 'c13-v17',
  ...
  {
    id: 'c13-v22',
    question: 'What does the noun כְּלִי mean?',
    hebrew: 'כְּלִי',
    options: ['vessel, implement, article', 'sacrifice, offering', 'clothing, garment', 'treasure, wealth'],
    correctIndex: 0,
    explanation: 'כְּלִי is anything made for use — a vessel, tool, weapon or piece of furniture. The plural כֵּלִים covers the furnishings of the tabernacle.',
  },
  {
    id: 'c13-v23',
  ...
  {
    id: 'c13-v29',
    question: 'How do עַד and עוֹלָם differ when they express duration?',
    hebrew: 'עַד vs. עוֹלָם',
    options: ['עַד marks a limit; עוֹלָם is unbounded time', 'עוֹלָם marks a limit; עַד means a brief moment', 'both are prepositions and must govern a noun', 'עַד refers to the future only; עוֹלָם to the past only'],
    correctIndex: 0,
    explanation: 'עַד is a preposition naming a terminus — "as far as, until". עוֹלָם is a noun for time out of mind in either direction, remote past or endless future; לְעוֹלָם is "forever".',
  },
  {
    id: 'c13-v30',
    question: 'The noun חַטָּאָה covers which pair of things?',
    hebrew: 'חַטָּאָה',
    options: ['the offender and the one who pardons', 'the offence and the sacrifice that removes it', 'the trespass and the restitution paid', 'the accusation and the legal verdict'],
    correctIndex: 1,
    explanation: 'חַטָּאָה (root חָטָא, "to miss the mark") denotes both the sin and the sin offering appointed for it, so context decides which sense is meant (Leviticus 4).',
  },
  {
    id: 'c13-v31',
    question: 'How do the two verbs of fearing יָרֵא and פָּחַד differ?',
    hebrew: 'יָרֵא vs. פָּחַד',
    options: ['יָרֵא can mean reverence; פָּחַד is sudden dread', 'פָּחַד means worship; יָרֵא is terror in battle', 'both refer only to fear of a human enemy', 'יָרֵא is a noun; פָּחַד is always a participle'],
    correctIndex: 0,
    explanation: 'יָרֵא spans fear and reverence — יִרְאַת יְהוָה, "the fear of the LORD". פָּחַד is to be startled or to dread, the sudden alarm named by the noun פַּחַד.',
  },
  {
    id: 'c13-v32',
    question: 'Which range of senses does the noun רֹאשׁ carry?',
    hebrew: 'רֹאשׁ',
    options: ['hand, palm, grasp, power', 'heart, mind, will, resolve', 'head, top, chief, beginning', 'mouth, speech, edge, command'],
    correctIndex: 2,
    explanation: 'רֹאשׁ is the literal head, then the top of a mountain, the chief of a people, and the beginning of a period — רֹאשׁ הַשָּׁנָה, "the head of the year".',
  },
  {
    id: 'c13-v33',
  ...
  {
    id: 'c13-v34',
    question: 'What does the verb עָנָה mean?',
    hebrew: 'עָנָה',
    options: ['to answer, respond', 'to call, summon', 'to ask, request', 'to swear, take an oath'],
    correctIndex: 0,
    explanation: 'עָנָה is "to answer, respond, testify". A separate verb spelled the same way means "to be afflicted, humbled" — the context, not the spelling, tells them apart.',
  },
  ...
  {
    id: 'c13-v38',
    question: 'What does the verb שׂוּם mean?',
    hebrew: 'שׂוּם',
    options: ['to put, place, set', 'to take, seize, grasp', 'to carry, lift up', 'to throw, cast down'],
    correctIndex: 0,
    explanation: 'שׂוּם is the general verb of placing — setting a thing somewhere, appointing someone to office, or putting words in a mouth.',
  },
  {
    id: 'c13-v39',
