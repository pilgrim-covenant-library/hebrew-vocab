...
export const class13GrammarQuestions: PracticeMCQ[] = [
  ...
  { id: 'c13-g05', question: 'Why is it הָאָרֶץ and not הַאָרֶץ?', hebrew: 'הָאָרֶץ', options: ['because the noun is feminine', 'because the noun is plural', 'because the word is in construct', 'because א is a guttural and cannot take the Daghesh Forte, so the article\'s vowel lengthens'], correctIndex: 3, explanation: 'Ch 5. Compensatory lengthening: Pathach becomes Qamets before א, ע and ר. Before ה and ח the article usually keeps Pathach with virtual doubling instead.' },
  ...
  { id: 'c13-g09', question: 'Parse the וְ in וְהָאָרֶץ (Genesis 1:2):', hebrew: 'וְהָאָרֶץ הָיְתָה תֹהוּ וָבֹהוּ', options: ['Waw Consecutive on an Imperfect', 'Waw Consecutive on a Perfect', 'a disjunctive waw — conjunction plus a fronted NOUN, giving background', 'the definite article'], correctIndex: 2, explanation: 'Ch 5, 17, 23. A waw followed by a noun rather than a verb steps out of the narrative sequence. Verse 1 uses ordinary verb-first order; verse 2 pauses to describe a state.' },
  ...
  // --- Ch 11: numbers ---
  { id: 'c13-g14', question: 'The number אֶחָד ("one") behaves grammatically like:', hebrew: 'אֶחָד', options: ['an adjective — it follows its noun and agrees with it', 'a verb', 'a preposition', 'a construct noun'], correctIndex: 0, explanation: 'Ch 11. Only "one" behaves this way. From "two" upward the numbers behave like NOUNS and can stand in construct.' },
  { id: 'c13-g15', question: 'What is surprising about the agreement of the numbers three through ten?', options: ['they have no plural', 'the gender is reversed — a masculine-form number counts feminine nouns and vice versa', 'they never take the article', 'they always precede the verb'], correctIndex: 1, explanation: 'Ch 11. The famous chiastic agreement. שְׁלֹשָׁה (masculine in form) counts feminine nouns, and שָׁלֹשׁ counts masculine ones.' },
  ...
  { id: 'c13-g19', question: 'A STATIVE verb such as כָּבֵד:', hebrew: 'כָּבֵד', options: ['describes a state rather than an action done to an object', 'is always causative', 'always takes a direct object', 'is always passive'], correctIndex: 0, explanation: 'Ch 13. "To be heavy, honoured." Note the Qamets-Tsere pattern that marks one class of statives.' },
  ...
  { id: 'c13-g28', question: 'Why does the stem vowel become Pathach in יִשְׁמַע?', hebrew: 'יִשְׁמַע', options: ['because a guttural third letter prefers an a-class vowel', 'because a נ has assimilated', 'because the verb is plural', 'because the syllable is open'], correctIndex: 0, explanation: 'Ch 16. The same guttural preference explains יִשְׁלַח and dozens of other forms — one rule, many payoffs.' },

  // --- Ch 17: Waw Consecutive ---
  { id: 'c13-g29', question: 'An IMPERFECT with the Waw Consecutive is translated with the values of:', hebrew: 'וַיִּקְטֹל', options: ['a Perfect — normally the English past', 'an unchanged Imperfect', 'an Imperative', 'a participle'], correctIndex: 0, explanation: 'Ch 17. The consecutive Imperfect is the backbone of Hebrew past narrative: וַיֹּאמֶר, "and he said."' },
  { id: 'c13-g30', question: 'A PERFECT with the Waw Consecutive is translated with the values of:', hebrew: 'וְקָטַל', options: ['an unchanged Perfect', 'an Imperfect — the future narrative sequence', 'an Imperative', 'an infinitive'], correctIndex: 1, explanation: 'Ch 17. The two consecutive forms swap time frames in opposite directions. וְשָׁמַרְתָּ = "and you shall keep."' },
  ...
  { id: 'c13-g37', question: 'What does the Infinitive Absolute do in מוֹת תָּמוּת?', hebrew: 'מוֹת תָּמוּת', options: ['it negates the verb', 'it intensifies the finite verb — "you shall SURELY die"', 'it makes the verb plural', 'it turns the clause into a question'], correctIndex: 1, explanation: 'Ch 21. The emphatic use: the Infinitive Absolute stands in front of a finite verb of the same root.' },
  ...
  { id: 'c13-g39', question: 'Parse בָּרוּךְ:', hebrew: 'בָּרוּךְ', options: ['Perfect 3ms — "he blessed"', 'Imperative — "bless!"', 'Qal PASSIVE participle — "blessed"', 'Infinitive Construct — "to bless"'], correctIndex: 2, explanation: 'Ch 22. The Shureq gives it away. בָּרוּךְ הַבָּא: a passive participle followed by an active one with the article.' },
  ...
  // --- Ch 24-25: Niphal ---
  { id: 'c13-g43', question: 'Parse יִקָּטֵל:', hebrew: 'יִקָּטֵל', options: ['Qal Imperfect 3ms', 'Niphal Imperfect 3ms — "he will be killed"', 'Piel Imperfect 3ms', 'Hiphil Imperfect 3ms'], correctIndex: 1, explanation: 'Ch 24. The Daghesh Forte in the first root consonant IS the assimilated stem נ. Compare the Perfect נִקְטַל, where the נ is written out.' },
  ...
  { id: 'c13-g45', question: 'How do you tell the Niphal Perfect נִקְטַל from the Niphal Participle נִקְטָל?', hebrew: 'נִקְטַל / נִקְטָל', options: ['by the stem vowel: Pathach in the Perfect, Qamets in the Participle', 'by the prefix', 'by the root', 'they cannot be distinguished'], correctIndex: 0, explanation: 'Ch 24. One vowel is the whole difference, which is why Niphal participles are so often misparsed as Perfects.' },
  ...
  { id: 'c13-g48', question: 'Which root would you look up for הִגִּיד?', hebrew: 'הִגִּיד', options: ['נָגַד ("to tell") — a I-נ verb', 'גָּדַל ("to be great")', 'גּוּר ("to sojourn")', 'נָגַשׁ ("to draw near")'], correctIndex: 0, explanation: 'Ch 27. The Daghesh Forte recovers the assimilated נ. Its Hophal passive is הֻגַּד, "it was told."' },
...
export const class13VocabQuestions: PracticeMCQ[] = [
  ...
  { id: 'c13-v21', question: 'What does אָמַן mean?', hebrew: 'אָמַן', options: ['to say', 'to gather', '(Ni) to be faithful, reliable; (Hi) to believe, trust', 'to bind'], correctIndex: 2, explanation: 'Ch 24 vocabulary. Genesis 15:6 uses its Hiphil: "and he believed the LORD."' },
  { id: 'c13-v22', question: 'What does יָשַׁע mean?', hebrew: 'יָשַׁע', options: ['to sit', 'to be left over', '(Ni) to be delivered; (Hi) to save, deliver', 'to give birth'], correctIndex: 2, explanation: 'Ch 24 vocabulary. The nouns יְשׁוּעָה ("salvation") and the name יְהוֹשֻׁעַ come from this root.' },
  ...
  { id: 'c13-v24', question: 'What does בָּקַשׁ mean?', hebrew: 'בָּקַשׁ', options: ['(Piel) to seek, search for, require', 'to choose', 'to trust', 'to understand'], correctIndex: 0, explanation: 'Ch 26 vocabulary. It occurs almost entirely in the Piel: בַּקְּשׁוּ פָנָי, "seek my face" (Ps 27:8).' },
  ...
  { id: 'c13-v29', question: 'What does פָּלַל mean?', hebrew: 'פָּלַל', options: ['(Hithpael) to pray, make intercession', 'to be wonderful', 'to turn', 'to open'], correctIndex: 0, explanation: 'Ch 34 vocabulary. It lives almost entirely in the Hithpael, and gives the noun תְּפִלָּה ("prayer").' },
  { id: 'c13-v30', question: 'What does חָוָה mean?', hebrew: 'חָוָה', options: ['to live', '(Hishtaphel) to bow down, worship', 'to camp', 'to burn with anger'], correctIndex: 1, explanation: 'Ch 35 vocabulary. Its form הִשְׁתַּחֲוָה is the standard biblical word for worship — and one of the hardest in the Bible to look up.' },
];
