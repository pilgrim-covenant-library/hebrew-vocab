...
export const class13VocabQuestions: PracticeMCQ[] = [
  ...
  {
    id: 'c13-v01',
    question: 'What does the verb בּוֹא mean?',
    hebrew: 'בּוֹא',
    options: ['to send, dispatch', 'to come, go in, enter', 'to stand, remain', 'to turn back, return'],
    correctIndex: 1,
    explanation: 'בּוֹא (2,592x) is the ordinary verb of arrival: Qal "come, go in, enter"; the Hiphil הֵבִיא means "bring in".',
  },
  {
    id: 'c13-v02',
    question: 'What does the noun פָּנִים mean?',
    hebrew: 'פָּנִים',
    options: ['face, presence', 'hands, palms', 'eyes, sight', 'feet, steps'],
    correctIndex: 0,
    explanation: 'פָּנִים ("face, presence") is plural in form but singular in sense, and it supplies the common prepositions לִפְנֵי ("before") and מִפְּנֵי ("from before").',
  },
  {
    id: 'c13-v03',
    question: 'What does the noun עִיר mean?',
    hebrew: 'עִיר',
    options: ['road, highway', 'field, pasture', 'city, town', 'house, dwelling'],
    correctIndex: 2,
    explanation: 'עִיר ("city, town") takes the irregular plural עָרִים — a form worth memorising, since the singular gives no hint of it.',
  },
  {
    id: 'c13-v04',
    question: 'What does the verb יָצָא mean?',
    hebrew: 'יָצָא',
    options: ['to go in, enter', 'to go out, come forth', 'to sit, dwell', 'to carry, bear'],
    correctIndex: 1,
    explanation: 'יָצָא is the verb of departure, and in the Hiphil הוֹצִיא ("bring out") it is the standard verb for the exodus from Egypt.',
  },
  {
    id: 'c13-v05',
    question: 'What does the noun מַיִם mean?',
    hebrew: 'מַיִם',
    options: ['fire, flame', 'water', 'dust, dry earth', 'wind, breath'],
    correctIndex: 1,
    explanation: 'מַיִם is plural in form but singular in sense, like פָּנִים. Its construct is מֵי, as in מֵי הַיַּרְדֵּן.',
  },
  {
    id: 'c13-v06',
  ...
  {
    id: 'c13-v07',
    question: 'What does the noun פֶּה mean?',
    hebrew: 'פֶּה',
    options: ['mouth, opening', 'hand, palm', 'eye, sight', 'ear, hearing'],
    correctIndex: 0,
    explanation: 'פֶּה is the mouth, and by extension an opening or an edge. The idiom לְפִי means "according to", literally "to the mouth of".',
  },
  {
    id: 'c13-v08',
    question: 'What does the noun צָבָא mean?',
    hebrew: 'צָבָא',
    options: ['army, host', 'city, town', 'tribe, clan', 'gate, entrance'],
    correctIndex: 0,
    explanation: 'צָבָא is an organised host — an army, the host of heaven, or a term of military service. It gives the title יְהוָה צְבָאוֹת.',
  },
  {
    id: 'c13-v09',
  ...
  {
    id: 'c13-v33',
    question: 'How do the two forms לֵב and לֵבָב relate to each other?',
    hebrew: 'לֵב vs. לֵבָב',
    options: ['לֵבָב is the plural of לֵב', 'לֵב is physical; לֵבָב is a place name', 'one noun with לֵבָב the longer form', 'לֵב is Aramaic; לֵבָב is Hebrew'],
    correctIndex: 2,
    explanation: 'Both are the same noun, "heart" — in Hebrew the seat of thought, will and choice rather than of feeling alone. לֵבָב is the fuller form, frequent in Deuteronomy: בְּכָל־לְבָבְךָ.',
  },
  {
    id: 'c13-v34',
  ...
  {
    id: 'c13-v37',
    question: 'What does the verb עָמַד mean?',
    hebrew: 'עָמַד',
    options: ['to sit, be seated', 'to lie down, rest', 'to bow, kneel down', 'to stand, take a stand'],
    correctIndex: 3,
    explanation: 'עָמַד is "to stand" — to take up a position, and figuratively to endure or persist. The Hiphil הֶעֱמִיד means "set up, station, appoint".',
  },
  {
    id: 'c13-v38',
  ...
  {
    id: 'c13-v40',
    question: 'What does the noun שַׂר mean?',
    hebrew: 'שַׂר',
    options: ['elder, city councillor', 'official, commander, prince', 'messenger, envoy', 'judge, arbiter'],
    correctIndex: 1,
    explanation: 'שַׂר is a head person of any rank — a commander of troops, a court official, or the prince of a province. שַׂר הַצָּבָא is the commander of the army.',
  },
];
