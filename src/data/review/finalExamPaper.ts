...
const finalExamGrammarReplacements: PracticeMCQ[] = [
  ...
  { id: 'fe-g02', question: 'Identify the function of dagesh forte in הַמֶּלֶךְ:', options: ['Marks pause', 'Marks doubling of the consonant', 'Marks long vowel', 'Marks the BeGaDKePhaT hardening'], correctIndex: 1, explanation: 'הַ + dagesh forte (doubling) in מ = the article. The article ALWAYS produces a dagesh in the next consonant (unless that consonant is a guttural).' },
  ...
  { id: 'fe-g04', question: 'Parse וְשָׁמַרְתָּ — a vav-consecutive perfect form:', options: ['Past ("and you kept")', 'Future / commanded ("and you shall keep")', 'Subjunctive ("you might keep")', 'Participle ("keeping")'], correctIndex: 1, explanation: 'וְשָׁמַרְתָּ = vav-consecutive PERFECT. In future/commanded contexts (after imperfect/imperative), it carries a future or modal sense: "and you shall keep."' },
  { id: 'fe-g05', question: 'Identify the form הַכֹּהֵן הַגָּדוֹל:', options: ['Predicative ("the priest is great")', 'Attributive ("the great priest")', 'Construct chain ("priest of great")', 'Apposition ("priest, great one")'], correctIndex: 1, explanation: 'Both noun and adjective have the article = ATTRIBUTIVE adjective: "the GREAT priest" (modifying). In predicative use, the adjective would lack the article.' },
  { id: 'fe-g06', question: 'In hi-...-i pattern (e.g., הִקְטִיל), the binyan is:', options: ['Qal', 'Niphal', 'Piel', 'Hiphil'], correctIndex: 3, explanation: 'הִקְטִיל = HIPHIL perfect 3ms. Prefix ה- + hi-…-i pattern in perfect = causative ("cause to X").' },
  { id: 'fe-g07', question: 'Parse the form נִכְתַּב:', options: ['Qal perfect 3ms', 'Niphal perfect 3ms', 'Piel perfect 3ms', 'Pual perfect 3ms'], correctIndex: 1, explanation: 'נ- prefix + perfect = NIPHAL perfect 3ms ("it was written"). Niphal often serves as the passive of the qal.' },
  { id: 'fe-g08', question: 'Parse the form הִתְפַּלֵּל:', options: ['Hiphil perfect 3ms', 'Niphal perfect 3ms', 'Hithpael perfect 3ms', 'Pual perfect 3ms'], correctIndex: 2, explanation: 'הִתְ- prefix + dagesh in middle root letter (פּ) = HITHPAEL perfect 3ms ("he prayed / made himself entreat"). Reflexive/reciprocal binyan.' },
