...
const numberQuestions: PracticeQuestion[] = [
  { id: 'class5-num-1', prompt: 'The number "one" (אֶחָד) behaves grammatically like a(n):', hebrew: 'אֶחָד', options: ['adjective — it follows and agrees with its noun', 'verb', 'preposition', 'conjunction'], correctIndex: 0, explanation: 'Only אֶחָד ("one") acts like an ADJECTIVE: it follows its noun and agrees with it in gender. Numbers two and higher instead behave like nouns.', category: 'number' },
  ...
  { id: 'class5-num-9', prompt: 'The ordinal numbers ("first," "second," "third") function grammatically like:', options: ['prepositions', 'verbs', 'adjectives — they follow the noun and agree with it', 'conjunctions'], correctIndex: 2, explanation: 'Ordinals such as רִאשׁוֹן ("first") and שֵׁנִי ("second") behave like adjectives, following their noun and agreeing in gender, number, and definiteness.', category: 'number' },
...
const verbQuestions: PracticeQuestion[] = [
  ...
  { id: 'class5-verb-3', prompt: 'How many verbal STEMS (binyanim) does Hebrew have?', options: ['seven — the Qal plus six derived stems', 'three', 'five', 'ten'], correctIndex: 0, explanation: 'Seven stems: the Qal and six derived stems (Niphal, Piel, Pual, Hiphil, Hophal, Hithpael). The stem signals the type and voice of the action.', category: 'verb-intro' },
  ...
  { id: 'class5-verb-6', prompt: 'How many CONJUGATIONS can a Hebrew verb take?', options: ['three', 'four', 'five', 'six (Perfect, Imperfect, Imperative, two Infinitives, Participle)'], correctIndex: 3, explanation: 'Six conjugations: Perfect, Imperfect, Imperative, Infinitive Construct, Infinitive Absolute, and Participle.', category: 'verb-intro' },
