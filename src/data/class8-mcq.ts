...
const ch20Questions: PracticeQuestion[] = [
  { id: 'class8-ch20-1', prompt: 'The Infinitive Construct is inflected for:', options: ['nothing — not person, gender, or number', 'person and number', 'gender only', 'person only'], correctIndex: 0, explanation: 'The Infinitive Construct has one basic form, which in strong verbs and many weak verbs is identical to the Qal Imperative 2ms: קְטֹל.', category: 'ch20' },
  ...
  { id: 'class8-ch20-5', prompt: 'How is the Infinitive Construct negated?', options: ['with לֹא', 'with אַל', 'with אֵין', 'with בִּלְתִּי or לְבִלְתִּי ("not," "in order not")'], correctIndex: 3, explanation: 'The ordinary verbal negatives לֹא and אַל are not used with the Infinitive Construct. Look for בִּלְתִּי or לְבִלְתִּי instead.', category: 'ch20' },
...
const ch20MemoryQuestions: PracticeQuestion[] = [
  { id: 'class8-memory-ch20-shevet', prompt: 'Which root would you look up for this Infinitive Construct?', hebrew: 'שֶׁבֶת', transliteration: 'shevet', options: ['יָשַׁב ("to sit, dwell") — a I-י verb', 'שָׁבַת ("to cease")', 'שֵׁבֶט ("tribe")', 'שׁוּב ("to return")'], correctIndex: 0, explanation: 'I-י verbs drop their Yod and take a segholate-style infinitive: יָשַׁב gives שֶׁבֶת. Compare יָדַע, which gives דַּעַת.', category: 'ch20-memory' },
  { id: 'class8-memory-ch20-tet', prompt: 'Which root would you look up for this Infinitive Construct?', hebrew: 'תֵּת', transliteration: 'tet', options: ['תָּמַם ("to be complete")', 'נָתַן ("to give") — a I-נ verb', 'תָּקַע ("to blow")', 'שִׁית ("to set")'], correctIndex: 1, explanation: 'נָתַן loses its first נ by assimilation and its final נ by the infinitive ending, leaving only תֵּת = "to give."', category: 'ch20-memory' },
  { id: 'class8-memory-ch20-asot', prompt: 'Which root would you look up for this Infinitive Construct?', hebrew: 'עֲשׂוֹת', transliteration: 'asot', options: ['עָלָה ("to go up")', 'עָבַד ("to serve")', 'עָשָׂה ("to do, make") — a III-ה verb', 'עָזַב ("to forsake")'], correctIndex: 2, explanation: 'III-ה verbs take a ־וֹת ending in the Infinitive Construct: עָשָׂה gives עֲשׂוֹת, בָּנָה gives בְּנוֹת, רָאָה gives רְאוֹת.', category: 'ch20-memory' },
  { id: 'class8-memory-ch20-qachat', prompt: 'Which root would you look up for this Infinitive Construct?', hebrew: 'קַחַת', transliteration: 'qachat', options: ['קָרָא ("to call")', 'קוּם ("to arise")', 'קָנָה ("to acquire")', 'לָקַח ("to take") — it behaves like a I-נ verb'], correctIndex: 3, explanation: 'לָקַח drops its ל in the Infinitive Construct exactly as it does in the Imperative (קַח) and the Imperfect (יִקַּח).', category: 'ch20-memory' },
  { id: 'class8-memory-ch20-daat', prompt: 'Which root would you look up for this Infinitive Construct?', hebrew: 'דַּעַת', transliteration: 'daat', options: ['יָדַע ("to know") — a I-י verb', 'דָּבַר ("to speak")', 'דָּרַשׁ ("to seek")', 'דּוֹר ("generation")'], correctIndex: 0, explanation: 'יָדַע gives the Infinitive Construct דַּעַת, "to know." The identical form also serves as the noun דַּעַת ("knowledge") — a verbal noun in the fullest sense.', category: 'ch20-memory' },
  { id: 'class8-memory-ch20-purpose', prompt: 'What does לְ plus an Infinitive Construct most often express?', options: ['a completed action', 'purpose — "in order to"', 'a prohibition', 'a question'], correctIndex: 1, explanation: 'It is the workhorse purpose construction of Biblical Hebrew: לִשְׁמֹר ("in order to keep"), לֶאֱכֹל ("to eat"), לֵאמֹר ("saying").', category: 'ch20-memory' },
];

// Chapter 21 — the Qal Infinitive Absolute: one form, four uses.
const ch21Questions: PracticeQuestion[] = [
  { id: 'class8-ch21-1', prompt: 'What is the strong-verb form of the Qal Infinitive Absolute?', options: ['קֹטֵל', 'קְטֹל', 'קָטוֹל (or defectively קָטֹל)', 'יִקְטֹל'], correctIndex: 2, explanation: 'The Infinitive Absolute has exactly one form to memorize, with a Qamets under the first root consonant and a Holem Waw (or plain Holem) as the stem vowel.', category: 'ch21' },
  { id: 'class8-ch21-2', prompt: 'What does an Infinitive Absolute do when paired with a finite verb of the SAME root?', options: ['it negates it', 'it turns it into a question', 'it makes it plural', 'it intensifies it — "surely, certainly"'], correctIndex: 3, explanation: 'This is the emphatic use, and it is by far the most common: the Infinitive Absolute stands in front of the finite verb and strengthens it.', category: 'ch21' },
...
const ch21MemoryQuestions: PracticeQuestion[] = [
  ...
  { id: 'class8-memory-ch21-qetol', prompt: 'Parse this form.', hebrew: 'קְטֹל', transliteration: 'qetol', options: ['Infinitive Absolute only', 'Infinitive Construct — and, identically spelled, the Imperative 2ms', 'passive participle', 'Perfect 3ms'], correctIndex: 1, explanation: 'In the strong verb the Infinitive Construct and the Imperative 2ms are spelled the same. Syntax tells them apart: an infinitive normally follows a preposition.', category: 'ch21-memory' },
...
const ch22Questions: PracticeQuestion[] = [
  ...
  { id: 'class8-ch22-3', prompt: 'Translate this participle.', hebrew: 'שֹׁמֵר', options: ['he kept', 'keeping / one who keeps / a keeper', 'keep!', 'he will keep'], correctIndex: 1, explanation: 'A participle can be rendered as an adjective ("keeping"), a substantive ("a keeper, the one who keeps"), or a durative present ("he is keeping") — the use in the clause decides.', category: 'ch22' },
  ...
  { id: 'class8-ch22-5', prompt: 'What are the three uses of the participle?', options: ['past, present, and future', 'attributive, predicative, and substantive', 'emphatic, imperatival, and complementary', 'construct, absolute, and definite'], correctIndex: 1, explanation: 'The same three uses you already learned for adjectives (Ch 7) apply to participles, active and passive alike.', category: 'ch22' },
  ...
  { id: 'class8-ch22-7', prompt: 'Which class of Qal active participle has NO Holem vowel?', options: ['the Biconsonantal class, which has Qamets throughout', 'the I-נ class', 'the III-ה class', 'the geminate class'], correctIndex: 0, explanation: 'בָּא ("coming"), קָם ("rising"), שָׁב ("returning") — Biconsonantal participles look like their own Perfect 3ms forms, so context has to decide.', category: 'ch22' },
...
export const CLASS8_WORD_GROUPS: PracticeQuestionGroup[] = [
  ...
  wordGroup({ id: 'class8-word-safar', hebrew: 'סָפַר', transliteration: 'safar', transliterationOptions: ['savav', 'sagar', 'sur', 'safar'], transliterationCorrectIndex: 3, meaning: 'to count; (Piel) to recount, tell', meaningOptions: ['to surround', 'to shut', 'to turn aside', 'to count; (Piel) to recount, tell'], meaningCorrectIndex: 3 }),
