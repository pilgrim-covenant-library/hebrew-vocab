...
const perfectWeakQuestions: PracticeQuestion[] = [
  { id: 'class6-pw-1', prompt: 'In a WEAK verb, what stays exactly the same as in the strong Qal Perfect?', options: ['the sufformative endings (־תִּי, ־תָּ, ־נוּ)', 'the meaning of the verb', 'the number of root letters that appear', 'the word order of the clause'], correctIndex: 0, explanation: 'The Perfect endings never change, however weak the root is. What changes is the spelling of the ROOT — so master the strong paradigm first, then learn what each weak class does to it.', category: 'perfect-weak' },
  { id: 'class6-pw-2', prompt: 'Translate this Qal Perfect verb.', hebrew: 'בָּנְתָה', options: ['he built', 'she built', 'you (2ms) built', 'they built'], correctIndex: 1, explanation: 'בָּנָה ("to build," a III-ה verb) + the 3fs ending ־ָה gives בָּנְתָה = "she built." The accent shift reduces the first stem vowel to shewa.', category: 'perfect-weak' },
  ...
  { id: 'class6-pw-7', prompt: 'Translate this Qal Perfect verb.', hebrew: 'עָשִׂיתָ', options: ['I did / made', 'he did / made', 'you (2ms) did / made', 'she did / made'], correctIndex: 2, explanation: 'עָשָׂה ("to do, make," a III-ה verb) + the 2ms ending ־תָ, with the diagnostic Hireq Yod, gives עָשִׂיתָ = "you (m.) did / made."', category: 'perfect-weak' },
  ...
  { id: 'class6-pw-9', prompt: 'Translate this Qal Perfect verb.', hebrew: 'שָׁתִיתָ', options: ['you (2ms) drank', 'I drank', 'he drank', 'she drank'], correctIndex: 0, explanation: 'שָׁתָה ("to drink," a III-ה verb) + the 2ms ending ־תָ, with the Hireq Yod, gives שָׁתִיתָ = "you (m.) drank."', category: 'perfect-weak' },
  { id: 'class6-pw-10', prompt: 'Translate this Qal Perfect clause.', hebrew: 'לָקַחְתָּ אֶת־הַסֵּפֶר', options: ['I took the book', 'you (2ms) took the book', 'he took the book', 'they took the book'], correctIndex: 1, explanation: 'לָקַח ("to take") is regular in the Perfect: + the 2ms ending ־תָּ = "you took." אֶת־ marks the definite object הַסֵּפֶר ("the book").', category: 'perfect-weak' },
];
...
const perfectWeakMemoryQuestions: PracticeQuestion[] = [
  ...
  { id: 'class6-memory-pw-qamta', prompt: 'Parse this Qal Perfect form.', hebrew: 'קַמְתָּ', transliteration: 'qamta', options: ['3ms — "he arose"', '2ms — "you (m.) arose"', '1cp — "we arose"', '3fs — "she arose"'], correctIndex: 1, explanation: 'In Biconsonantal verbs the first- and second-person forms switch to Pathach: קַמְתָּ = "you (m.) arose." Compare the third-person Qamets of קָם.', category: 'perfect-memory' },
  { id: 'class6-memory-pw-meth', prompt: 'Parse this Qal Perfect form.', hebrew: 'מֵת', transliteration: 'meth', options: ['1cs — "I died"', '3cp — "they died"', '3ms — "he died"', '2ms — "you died"'], correctIndex: 2, explanation: 'מוּת ("to die") is Biconsonantal with a Tsere third person: מֵת = "he died." Memorize it beside קָם ("he arose").', category: 'perfect-memory' },
  ...
  { id: 'class6-memory-pw-hayitha', prompt: 'Parse this Qal Perfect form.', hebrew: 'הָיִיתָ', transliteration: 'hayitha', options: ['1cs — "I was"', '2ms — "you (m.) were"', '3ms — "he was"', '1cp — "we were"'], correctIndex: 1, explanation: 'הָיָה ("to be") is III-ה, so it takes the Hireq Yod like בָּנָה: הָיִיתָ = "you (m.) were."', category: 'perfect-memory' },
];
...
const imperfectStrongQuestions: PracticeQuestion[] = [
  ...
  { id: 'class6-is-3', prompt: 'The Imperfect is called the PREFIX conjugation because:', options: ['it is always negated', 'it never takes endings', 'every form begins with a preformative (י, ת, א, נ) marking the subject', 'it always follows the subject'], correctIndex: 2, explanation: 'The Perfect marks its subject with endings; the Imperfect marks it mainly with a PREFIX — י ("he"), ת ("she / you"), א ("I"), נ ("we") — sometimes with an ending as well.', category: 'imperfect-strong' },
  ...
  { id: 'class6-is-6', prompt: 'Translate this Qal Imperfect verb.', hebrew: 'יִשְׁמְרוּ', options: ['he will keep', 'they will keep', 'we will keep', 'you (f.) will keep'], correctIndex: 1, explanation: 'The י preformative plus the ־וּ ending marks 3mp: יִשְׁמְרוּ = "they will keep." Plural endings shorten the stem vowel to a shewa.', category: 'imperfect-strong' },
  ...
  { id: 'class6-is-10', prompt: 'Translate this Qal Imperfect clause.', hebrew: 'תִּזְכְּרִי אֶת־הַבְּרִית', options: ['You (f.) will remember the covenant', 'They will remember the covenant', 'We will remember the covenant', 'He will remember the covenant'], correctIndex: 0, explanation: 'The ת preformative with the ־ִי ending marks 2fs: תִּזְכְּרִי = "you (f.) will remember"; אֶת־ marks the definite object הַבְּרִית ("the covenant").', category: 'imperfect-strong' },
];
...
const imperfectWeakMemoryQuestions: PracticeQuestion[] = [
  { id: 'class6-memory-iw-yippol', prompt: 'Which root would you look up for this form?', hebrew: 'יִפֹּל', transliteration: 'yippol', options: ['נָפַל ("to fall") — a I-נ verb', 'פָּלַל ("to pray")', 'יָפָה ("to be beautiful")', 'פָּלַט ("to escape")'], correctIndex: 0, explanation: 'The Daghesh Forte in the פ restores an assimilated נ: יִפֹּל → נָפַל ("to fall").', category: 'weak-memory' },
  { id: 'class6-memory-iw-yitten', prompt: 'Which root would you look up for this form?', hebrew: 'יִתֵּן', transliteration: 'yitten', options: ['תָּמַם ("to be complete")', 'נָתַן ("to give") — a I-נ verb', 'יָתַר ("to remain")', 'תָּפַשׂ ("to seize")'], correctIndex: 1, explanation: 'The Daghesh Forte in the ת restores the assimilated נ: יִתֵּן → נָתַן ("to give").', category: 'weak-memory' },
  { id: 'class6-memory-iw-yiqqach', prompt: 'Which root would you look up for this form?', hebrew: 'יִקַּח', transliteration: 'yiqqach', options: ['נָקַם ("to avenge")', 'קָרָא ("to call")', 'לָקַח ("to take") — it assimilates like a I-נ verb', 'קָוָה ("to wait")'], correctIndex: 2, explanation: 'לָקַח is the one non-נ verb that assimilates its first letter: the Daghesh Forte in the ק restores the ל, giving יִקַּח = "he will take."', category: 'weak-memory' },
  { id: 'class6-memory-iw-yeshev', prompt: 'Which class does this Imperfect belong to?', hebrew: 'יֵשֵׁב', transliteration: 'yeshev', options: ['a geminate verb', 'a III-ה verb', 'a Biconsonantal verb', 'a I-י verb — the Tsere preformative marks the dropped Yod'], correctIndex: 3, explanation: 'A Tsere under the preformative is the Type 1 I-י diagnostic: יֵשֵׁב → יָשַׁב ("to sit, dwell").', category: 'weak-memory' },
  { id: 'class6-memory-iw-telekh', prompt: 'Which root would you look up for this form?', hebrew: 'תֵּלֵךְ', transliteration: 'telekh', options: ['הָלַךְ ("to walk") — it inflects like a I-י verb', 'תָּלָה ("to hang")', 'יָלַךְ, an unrelated root', 'מָלַךְ ("to reign")'], correctIndex: 0, explanation: 'הָלַךְ behaves like a Type 1 I-י verb in the Imperfect, so its forms have a Tsere preformative and no ה: תֵּלֵךְ = "she / you will walk."', category: 'weak-memory' },
  { id: 'class6-memory-iw-yivneh', prompt: 'Which ending identifies this Imperfect as a III-ה verb?', hebrew: 'יִבְנֶה', transliteration: 'yivneh', options: ['the Daghesh Forte', 'the Seghol-He ending (ֶה)', 'the Hireq Yod', 'the Holem Waw'], correctIndex: 1, explanation: 'III-ה Imperfect forms without a sufformative always end in Seghol-He: יִבְנֶה ("he will build"), יַעֲשֶׂה ("he will do").', category: 'weak-memory' },
  ...
  { id: 'class6-memory-iw-yaqum', prompt: 'Which class does this Imperfect belong to?', hebrew: 'יָקוּם', transliteration: 'yaqum', options: ['a I-נ verb', 'a III-א verb', 'a geminate verb', 'a Biconsonantal verb — the middle Shureq returns'], correctIndex: 3, explanation: 'Biconsonantal (hollow) verbs restore their middle vowel letter in the Imperfect and take a Qamets preformative: יָקוּם → קוּם ("to arise").', category: 'weak-memory' },
