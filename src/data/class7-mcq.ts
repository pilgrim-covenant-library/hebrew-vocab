...
const ch17Questions: PracticeQuestion[] = [
  { id: 'class7-ch17-1', prompt: 'When an IMPERFECT verb is prefixed with the Waw Consecutive, it is translated with the values of:', options: ['a Perfect verb', 'an Imperfect verb', 'an Imperative', 'a participle'], correctIndex: 0, explanation: 'The consecutive Imperfect carries Perfect values: "and he killed," or with the present perfect, "and he has killed." This is the backbone of Hebrew narrative.', category: 'ch17' },
  ...
  { id: 'class7-ch17-4', prompt: 'When a PERFECT verb is prefixed with the Waw Consecutive, it is translated with the values of:', options: ['an Imperfect verb', 'a Perfect verb', 'an infinitive', 'a participle'], correctIndex: 0, explanation: 'The consecutive Perfect carries Imperfect values and drives the FUTURE narrative sequence: וְשָׁמַרְתָּ = "and you shall keep." The two consecutive forms swap time frames in opposite directions.', category: 'ch17' },
...
const ch17MemoryQuestions: PracticeQuestion[] = [
  ...
  { id: 'class7-memory-ch17-vayehi', prompt: 'What is the difference between וַיְהִי and וְהָיָה?', hebrew: 'וַיְהִי / וְהָיָה', options: ['there is none; they are spelling variants', 'the first is plural, the second singular', 'the first is past narrative, the second future narrative', 'the first is a question, the second a statement'], correctIndex: 2, explanation: 'וַיְהִי is a consecutive Imperfect and introduces past narrative; וְהָיָה is a consecutive Perfect and introduces future narrative. The same root, opposite time frames — decided entirely by which conjugation the waw sits on.', category: 'ch17-memory' },
...
const ch18Questions: PracticeQuestion[] = [
  ...
  { id: 'class7-ch18-3', prompt: 'Translate this Imperative.', hebrew: 'שְׁמֹר', options: ['he kept', 'keep!', 'keeping', 'to keep'], correctIndex: 1, explanation: 'שְׁמֹר is the Qal Imperative 2ms of שָׁמַר: "keep! / guard!" It is the Imperfect תִּשְׁמֹר with the preformative removed.', category: 'ch18' },
  { id: 'class7-ch18-4', prompt: 'Translate this Imperative.', hebrew: 'שִׁמְרוּ', options: ['they kept', 'we shall keep', 'he will keep them', 'keep!'], correctIndex: 3, explanation: 'שִׁמְרוּ is the Qal Imperative 2mp: "keep!" addressed to a group. The ־וּ ending is the same plural marker you know from the Imperfect.', category: 'ch18' },
  { id: 'class7-ch18-5', prompt: 'How does Hebrew express a NEGATIVE command?', options: ['by negating the Imperative with לֹא', 'by adding a negative suffix to the Imperative', 'with לֹא or אַל followed by a second-person Imperfect', 'with אֵין plus the Imperative'], correctIndex: 2, explanation: 'The Imperative is never negated. Prohibitions use לֹא + Imperfect (permanent: "you shall not...") or אַל + Imperfect (immediate: "do not...!").', category: 'ch18' },
...
const ch18MemoryQuestions: PracticeQuestion[] = [
  ...
  { id: 'class7-memory-ch18-nefol', prompt: 'Which root would you look up for this Imperative?', hebrew: 'נְפֹל', transliteration: 'nefol', options: ['נָפַל ("to fall")', 'פָּלַל ("to pray")', 'נָפַשׁ ("to rest")', 'פָּלַט ("to escape")'], correctIndex: 0, explanation: 'A I-נ verb assimilates its נ in the Imperfect (יִפֹּל) but keeps it in the Imperative: נְפֹל = "fall!"', category: 'ch18-memory' },
  { id: 'class7-memory-ch18-qach', prompt: 'Which root would you look up for this Imperative?', hebrew: 'קַח', transliteration: 'qach', options: ['קוּם ("to arise")', 'לָקַח ("to take")', 'קָרָא ("to call")', 'קָנָה ("to acquire")'], correctIndex: 1, explanation: 'לָקַח loses its ל in the Imperative just as it assimilates it in the Imperfect (יִקַּח): קַח = "take!" It appears constantly with נָא — קַח־נָא, "take, please."', category: 'ch18-memory' },
];
...
const ch19Questions: PracticeQuestion[] = [
  ...
  { id: 'class7-ch19-2', prompt: 'Which suffix type do Perfect, Imperfect, and Imperative verbs generally take?', options: ['Type 1 suffixes with objective value', 'Type 2 suffixes with possessive value', 'Type 1 suffixes with subjective value', 'Type 2 suffixes with reflexive value'], correctIndex: 0, explanation: 'On a noun a suffix is possessive ("my word"); on a verb the same Type 1 suffix is objective ("he kept me"). The form is familiar — only the translation value changes.', category: 'ch19' },
  ...
  { id: 'class7-ch19-6', prompt: 'Which connecting vowels do the different conjugations prefer before a suffix?', options: ['all conjugations prefer Shewa', 'the Perfect prefers e-class; the Imperfect prefers a-class', 'the Perfect prefers a-class; the Imperfect and Imperative prefer e-class', 'neither conjugation uses connecting vowels'], correctIndex: 2, explanation: 'When a verb ends in a consonant, a connecting vowel is usually inserted before the suffix. Knowing which class to expect keeps you from misreading the stem.', category: 'ch19' },
...
const ch19MemoryQuestions: PracticeQuestion[] = [
  ...
  { id: 'class7-memory-ch19-reduction', prompt: 'What happens to the Holem stem vowel of an Imperfect like יִקְטֹל when a suffix is added?', options: ['it lengthens to Qamets', 'it stays unchanged', 'it becomes a Shureq', 'it reduces to a vocal Shewa'], correctIndex: 3, explanation: 'The accent moves toward the suffix, so the stem vowel reduces: יִקְטֹל becomes יִקְטְלֵנִי ("he will kill me"). Expect vowel reduction whenever a suffix pulls the accent forward.', category: 'ch19-memory' },
];
