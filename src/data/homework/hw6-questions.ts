...
const sec1: MCQQuestion[] = [
  { id: 'hw6-s1-q1', type: 'mcq', question: 'Even in WEAK verbs, one thing never changes. What?', options: ['the Perfect sufformatives (the endings)', 'the meaning of the verb', 'the number of root letters', 'the word order'], correctIndex: 0, explanation: 'CourseGuide Ch 14. The Perfect sufformatives (־תִּי, ־תָּ, ־נוּ, ...) stay the same no matter how weak the root is. What changes is the spelling of the root, not the endings — so master the strong paradigm first.', category: 'perfect-weak' },
  ...
  { id: 'hw6-s1-q9', type: 'mcq', question: 'In a III-א weak verb (e.g. מָצָא), the א is:', options: ['doubled', 'replaced by ה', 'always accented', 'quiescent (silent), so the ת of the endings loses its Daghesh Lene'], correctIndex: 3, explanation: 'CourseGuide Ch 14. The א of a III-א verb quiesces (goes silent). Because the ת of the sufformative is now preceded by a vowel sound, it loses its Daghesh Lene (מָצָאתָ).', category: 'perfect-weak' },
...
const sec3: MCQQuestion[] = [
  ...
  { id: 'hw6-s3-q2', type: 'mcq', question: 'A I-נ verb (like נָפַל "to fall") in the Imperfect:', options: ['keeps its נ visible', 'drops the נ with no trace', 'assimilates its נ into the next letter as a Daghesh Forte (יִפֹּל)', 'doubles the נ'], correctIndex: 2, explanation: 'CourseGuide Ch 16. The נ assimilates into the second root letter, leaving a Daghesh Forte: נָפַל → יִפֹּל ("he will fall"). That Daghesh Forte is how you recover the missing נ.', category: 'imperfect-weak' },
