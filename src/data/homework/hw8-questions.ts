...
const sec1: MCQQuestion[] = [
  { id: 'hw8-s1-q1', type: 'mcq', question: 'The Infinitive Construct is inflected for:', options: ['neither person, gender, nor number', 'person and number', 'gender only', 'number only'], correctIndex: 0, explanation: 'CourseGuide Ch 20. It has one basic form, which in the strong verb and many weak verbs is identical to the Qal Imperative 2ms: קְטֹל.', category: 'infinitive-construct' },
...
const sec2: MCQQuestion[] = [
  { id: 'hw8-s2-q1', type: 'mcq', question: 'What is the strong-verb form of the Qal Infinitive Absolute?', options: ['קָטוֹל', 'קֹטֵל', 'קְטֹל', 'יִקְטֹל'], correctIndex: 0, explanation: 'CourseGuide Ch 21. One form only: Qamets under the first root consonant, Holem Waw (or plain Holem) as the stem vowel.', category: 'infinitive-absolute' },
  ...
  { id: 'hw8-s2-q4', type: 'mcq', question: 'What does an Infinitive Absolute do when it stands before a finite verb of the SAME root?', options: ['it negates it', 'it makes it a question', 'it makes it plural', 'it intensifies it'], correctIndex: 3, explanation: 'CourseGuide Ch 21. This is the emphatic use: מוֹת תָּמוּת, "you shall SURELY die" (Gen 2:17).', category: 'infinitive-absolute' },
  ...
  { id: 'hw8-s2-q9', type: 'mcq', question: 'Which use is at work in שָׁמוֹר אֶת־יוֹם הַשַּׁבָּת (Deuteronomy 5:12)?', hebrew: 'שָׁמוֹר אֶת־יוֹם הַשַּׁבָּת', options: ['the imperatival use', 'the emphatic use', 'the complementary use', 'the simultaneous use'], correctIndex: 0, explanation: 'CourseGuide Ch 21. There is no finite verb of the same root for it to intensify; standing at the head of the clause, it commands: "Observe!"', category: 'infinitive-absolute' },
  { id: 'hw8-s2-q10', type: 'mcq', question: 'Which weak classes depart from the plain קָטוֹל pattern?', options: ['I-נ, I-י, and I-א verbs', 'III-Guttural, III-ה, and Biconsonantal verbs', 'geminate verbs only', 'no weak classes depart from it'], correctIndex: 1, explanation: 'CourseGuide Ch 21. Most weak verbs follow the strong pattern. Those three classes are the exceptions worth noting.', category: 'infinitive-absolute' },
];
...
const sec4: PairedMCQQuestion[] = [
  ...
  vocab('hw8-s4-q2', 'נָחָה', 'nachah', ['nasa', 'nus', 'naga'], 2, 'to rest, settle down; to give rest', ['to set out', 'to flee', 'to touch'], 0, 'Ch 21 vocab. Its Hiphil is used of God giving his people rest in the land.'),
