...
const sec2: MCQQuestion[] = [
  ...
  { id: 'hw3-s2-q14', type: 'mcq', question: 'What does בְּתוֹךְ mean?', hebrew: 'בְּתוֹךְ', options: ['in the midst (middle) of, inside', 'between', 'on account of', 'to, toward'], correctIndex: 0, explanation: 'Ch 6 vocab. בְּתוֹךְ = "in the midst of, inside," as in Gen 2:9 בְּתוֹךְ הַגָּן ("in the midst of the garden").', category: 'preposition-vocab' },
...
const sec3: MCQQuestion[] = [
  ...
  { id: 'hw3-s3-q12', type: 'mcq', question: 'Does the gender of an adjective change its meaning?', options: ['Yes, always', 'Only in the plural', 'Only when attributive', 'No — gender and number mark agreement, not meaning'], correctIndex: 3, explanation: 'CourseGuide Ch 7. The gender of an adjective does not change its meaning, and adjectives that are plural in form keep the same translation value — the endings simply agree with the modified noun.', category: 'adjective' },
];
