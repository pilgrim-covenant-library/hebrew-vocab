...
const sec1: MCQQuestion[] = [
  ...
  { id: 'hw12-s1-q9', type: 'mcq', question: 'Parse: הִתְקַטֵּל', hebrew: 'הִתְקַטֵּל', options: ['Hithpael Perfect 3ms (also spelled the same as the Imperative and Infinitive Construct)', 'Hiphil Perfect 3ms', 'Niphal Perfect 3ms', 'Piel Perfect 3ms'], correctIndex: 0, explanation: 'CourseGuide Ch 34. הִתְ prefix, Pathach under the first root consonant, Daghesh Forte in the second.', category: 'hithpael-strong' },
  ...
  { id: 'hw12-s1-q13', type: 'mcq', question: 'Which root would you look up for הִשְׁתַּמֵּר?', hebrew: 'הִשְׁתַּמֵּר', options: ['שָׁמַר ("to keep") — the prefix ת has metathesized with the שׁ', 'שָׁתָה ("to drink")', 'תָּמַם ("to be complete")', 'מָרַר ("to be bitter")'], correctIndex: 0, explanation: 'CourseGuide Ch 34. A שׁ followed by a ת at the front of a word should make you suspect a Hithpael with metathesis.', category: 'hithpael-strong' },
...
const sec2: MCQQuestion[] = [
  ...
  { id: 'hw12-s2-q12', type: 'mcq', question: 'Parse: מִשְׁתַּחֲוִים', hebrew: 'מִשְׁתַּחֲוִים', options: ['Hishtaphel participle mp — "bowing down, worshiping"', 'Hithpael Perfect 3cp', 'Piel participle mp', 'Niphal participle mp'], correctIndex: 0, explanation: 'CourseGuide Ch 35. The מ prefix marks the participle, the שׁת shows the metathesized stem, and ־ִים is the ordinary masculine plural ending (Gen 37:9).', category: 'hithpael-weak' },
  { id: 'hw12-s2-q13', type: 'mcq', question: 'How is the Hithpael negated in a prohibition?', options: ['with אֵין', 'with בִּלְתִּי', 'it cannot be negated', 'like any other verb — with לֹא or אַל plus the Imperfect'], correctIndex: 3, explanation: 'CourseGuide Ch 18/34. אַל־תִּתְחַר בַּמְּרֵעִים ("Fret not yourself because of evildoers," Ps 37:1) uses אַל with a Hithpael Imperfect.', category: 'hithpael-weak' },
...
const sec3: PairedMCQQuestion[] = [
  vocab('hw12-s3-q1', 'פָּלַל', 'palal', ['pala', 'panah', 'patach'], 0, '(Hithpael) to pray, make intercession', ['to be wonderful', 'to turn', 'to open'], 1, 'Ch 34 vocab. The root behind תְּפִלָּה ("prayer"), also Chapter 35 vocabulary.'),
  vocab('hw12-s3-q2', 'חָוָה', 'chavah', ['chayah', 'chanah', 'charah'], 1, '(Hishtaphel) to bow down, worship', ['to live', 'to camp', 'to burn with anger'], 0, 'Ch 35 vocab. Its Hishtaphel הִשְׁתַּחֲוָה is the standard biblical word for worship.'),
