...
const sec2: MCQQuestion[] = [
  ...
  { id: 'hw4-s2-q5', type: 'mcq', question: 'A feminine noun ending in ־ָה (e.g. תּוֹרָה) does what before a suffix?', options: ['keeps the ־ָה unchanged', 'takes the plural ending ־וֹת', 'the ה is replaced by ת (־ָה → ־ָת)', 'adds the dual ־ַיִם'], correctIndex: 2, explanation: 'CourseGuide Ch 9. The feminine ־ָה reverts to ־ָת before a suffix: תּוֹרָה → תּוֹרָתוֹ ("his law"). The same ת appears in the construct state.', category: 'suffix' },
  ...
  { id: 'hw4-s2-q10', type: 'mcq', question: 'In the paradigm לִי, לְךָ, לָךְ, לוֹ, לָהּ..., what is being suffixed?', options: ['the noun סוּס', 'the preposition לְ ("to, for")', 'the article', 'the conjunction וְ'], correctIndex: 1, explanation: 'CourseGuide Ch 9. This is the preposition לְ with Type 1 suffixes: לִי ("to me"), לְךָ ("to you," ms), לָךְ ("to you," fs), לוֹ ("to him"), לָהּ ("to her"). A suffix on a preposition is objective.', category: 'suffix' },
];
