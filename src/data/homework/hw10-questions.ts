...
const sec1: MCQQuestion[] = [
  ...
  { id: 'hw10-s1-q4', type: 'mcq', question: 'Which vowel stands under Hiphil preformatives and prefixes?', options: ['Qamets everywhere', 'Shewa everywhere', 'Qibbuts everywhere', 'Pathach — except in the Perfect, where it is Hireq'], correctIndex: 3, explanation: 'CourseGuide Ch 26. הִקְטִיל takes Hireq; יַקְטִיל, הַקְטֵל and מַקְטִיל all take Pathach.', category: 'hiphil-strong' },
  { id: 'hw10-s1-q5', type: 'mcq', question: 'What is the characteristic Hiphil STEM vowel?', options: ['Hireq Yod or Tsere — except in the 1st and 2nd person Perfect, where it is Pathach', 'Qamets throughout', 'Shureq throughout', 'Qibbuts throughout'], correctIndex: 0, explanation: 'CourseGuide Ch 26. הִקְטִיל, יַקְטִיל and מַקְטִיל show the Hireq Yod; הַקְטֵל shows the Tsere; הִקְטַלְתָּ shows the Pathach.', category: 'hiphil-strong' },
...
const sec2: MCQQuestion[] = [
  { id: 'hw10-s2-q1', type: 'mcq', question: 'How much of the strong-verb Hiphil survives in the weak classes?', options: ['nearly all of it — the prefixes and preformatives are preserved, and mainly stem vowels vary', 'almost nothing', 'only the Perfect', 'only the Participle'], correctIndex: 0, explanation: 'CourseGuide Ch 27. Master the strong diagnostics and most weak Hiphils are already readable.', category: 'hiphil-weak' },
  { id: 'hw10-s2-q2', type: 'mcq', question: 'In I-guttural Hiphil verbs, the first root consonant takes:', options: ['a Daghesh Forte', 'a reduced vowel — Hateph Seghol in the Perfect, Hateph Pathach elsewhere', 'a Shureq', 'no vowel at all'], correctIndex: 1, explanation: 'CourseGuide Ch 27. It is not itself diagnostic, but noticing it keeps forms like הֶאֱמִין from looking foreign.', category: 'hiphil-weak' },
  ...
  { id: 'hw10-s2-q4', type: 'mcq', question: 'How do I-י roots (originally I-ו) look in the Hiphil?', options: ['they lose the first root letter entirely', 'they double the second root letter', 'they gain a ה at the end', 'the י is replaced by a Holem Waw — הוֹשִׁיעַ, הוֹצִיא'], correctIndex: 3, explanation: 'CourseGuide Ch 27. The Holem Waw plus a Hireq Yod is one of the most common Hiphil shapes in the Hebrew Bible.', category: 'hiphil-weak' },
  ...
  { id: 'hw10-s2-q7', type: 'mcq', question: 'Which root would you look up for הֵקִים?', hebrew: 'הֵקִים', options: ['קָנָה ("to acquire")', 'קוּם ("to arise") — a Biconsonantal verb', 'קָלַל ("to be small")', 'קָרָא ("to call")'], correctIndex: 1, explanation: 'CourseGuide Ch 27. Biconsonantal Hiphils contract to a Tsere prefix vowel plus the middle vowel letter: "he raised up, established."', category: 'hiphil-weak' },
  { id: 'hw10-s2-q8', type: 'mcq', question: 'In III-ה Hiphil verbs, where does the variation appear?', options: ['in the prefixes only', 'nowhere at all', 'mainly in the stem vowels — the prefixes and preformatives keep the strong diagnostics', 'the whole paradigm is unrecognizable'], correctIndex: 2, explanation: 'CourseGuide Ch 27. The III-ה endings are the same ones that appear on III-ה verbs in the Qal and in every derived stem.', category: 'hiphil-weak' },
];

// Section 3 — Chapter 28: the Hophal stem, strong verbs.
const sec3: MCQQuestion[] = [
  { id: 'hw10-s3-q1', type: 'mcq', question: 'What type of action and voice does the Hophal express?', options: ['causative action with a PASSIVE voice — in most cases the passive of the Hiphil', 'causative action with an active voice', 'intensive action with an active voice', 'reflexive action'], correctIndex: 0, explanation: 'CourseGuide Ch 28. הִמְלִיךְ ("he made someone king") gives הָמְלַךְ ("he was made king").', category: 'hophal-strong' },
  { id: 'hw10-s3-q2', type: 'mcq', question: 'What distinguishes Hophal conjugations from the other derived stems?', options: ['a doubled second root consonant', 'their prefix or preformative vowel — Qibbuts or Qamets Hatuf', 'a נ prefix', 'a Hireq Yod stem vowel'], correctIndex: 1, explanation: 'CourseGuide Ch 28. It is best to think in vowel CLASSES: u-class or o-class under the prefix.', category: 'hophal-strong' },
  ...
  { id: 'hw10-s3-q5', type: 'mcq', question: 'Which form is a Hophal Perfect 3ms of √q-t-l?', options: ['הִקְטִיל', 'נִקְטַל', 'הָקְטַל (or הֻקְטַל)', 'קֻטַּל'], correctIndex: 2, explanation: 'CourseGuide Ch 28. An o-class or u-class prefix vowel plus a Pathach stem vowel. Compare the Hiphil הִקְטִיל.', category: 'hophal-strong' },
  ...
  { id: 'hw10-s3-q7', type: 'mcq', question: 'What is the only difference between הִקְטִיל and הָקְטַל?', hebrew: 'הִקְטִיל / הָקְטַל', options: ['the root', 'the person', 'the vowels — and with them the voice: active Hiphil versus passive Hophal', 'the number'], correctIndex: 2, explanation: 'CourseGuide Ch 28. Same consonants, same root, same person. Only the vowels separate "he caused" from "he was caused."', category: 'hophal-strong' },
...
const sec5: PairedMCQQuestion[] = [
  vocab('hw10-s5-q1', 'בָּקַשׁ', 'baqash', ['bachar', 'batach', 'bin'], 0, '(Piel) to seek, search for, require', ['to choose', 'to trust', 'to understand'], 1, 'Ch 26 vocab. Occurs almost entirely in the Piel: בַּקְּשׁוּ פָנָי, "seek my face" (Ps 27:8).'),
  vocab('hw10-s5-q2', 'מָהַר', 'mahar', ['maas', 'makhar', 'mashal'], 1, '(Piel) to hasten, hurry, go quickly', ['to reject', 'to sell', 'to rule'], 2, 'Ch 26 vocab. Its participle is often used adverbially: "quickly."'),
  vocab('hw10-s5-q3', 'צָוָה', 'tsavah', ['tsar', 'tsur', 'tsarah'], 2, '(Piel) to command, give an order, charge', ['adversary', 'rock', 'distress'], 0, 'Ch 26 vocab. The root behind מִצְוָה ("commandment").'),
