...
const sec1: MCQQuestion[] = [
  { id: 'hw7-s1-q1', type: 'mcq', question: 'An IMPERFECT verb prefixed with the Waw Consecutive is translated with the values of:', options: ['a Perfect verb — normally the English past tense', 'an unchanged Imperfect', 'an Imperative', 'a participle'], correctIndex: 0, explanation: 'CourseGuide Ch 17. The consecutive Imperfect takes Perfect values: "he killed" or "he has killed." This is the standard past-tense narrative form of the Hebrew Bible.', category: 'waw-consecutive' },
  { id: 'hw7-s1-q2', type: 'mcq', question: 'A PERFECT verb prefixed with the Waw Consecutive is translated with the values of:', options: ['a participle', 'an Imperfect — the future narrative sequence', 'an unchanged Perfect', 'an infinitive'], correctIndex: 1, explanation: 'CourseGuide Ch 17. The consecutive Perfect drives FUTURE narrative sequence: וְשָׁמַרְתָּ = "and you shall keep." The two consecutive forms swap time frames in opposite directions.', category: 'waw-consecutive' },
  ...
  { id: 'hw7-s1-q4', type: 'mcq', question: 'Does prefixing the Waw Consecutive change the spelling of the Imperfect verb itself?', options: ['yes, it removes the preformative', 'yes, it adds a sufformative', 'yes, it doubles the last root letter', 'no — in most verb classes the Imperfect keeps its spelling'], correctIndex: 3, explanation: 'CourseGuide Ch 17. Only the waw is added. That is exactly why the form is easy to misread: it looks like a familiar Imperfect, but its time value has flipped to past.', category: 'waw-consecutive' },
  ...
  { id: 'hw7-s1-q8', type: 'mcq', question: 'Parse: וְזָכַר', hebrew: 'וְזָכַר', options: ['Qal Imperfect 3ms of זכר with Waw Consecutive', 'Qal Imperative 2ms of זכר', 'Qal Perfect 3mp of זכר with Waw Consecutive', 'Qal Perfect 3ms of זכר with the conjunction — and possibly the Waw Consecutive; only context decides'], correctIndex: 3, explanation: 'CourseGuide Ch 17. In the 3ms the consecutive Perfect and the plain conjunction look identical. Only in the 2ms and 1cs does the accent shift give the Waw Consecutive away — elsewhere, context decides.', category: 'waw-consecutive' },
  { id: 'hw7-s1-q9', type: 'mcq', question: 'Translate: וַתֹּאמֶר', hebrew: 'וַתֹּאמֶר', options: ['and she said (or: and you said)', 'and they said', 'and I said', 'and we said'], correctIndex: 0, explanation: 'CourseGuide Ch 17. The ת preformative is ambiguous between 3fs and 2ms, exactly as in the plain Imperfect. Context resolves it.', category: 'waw-consecutive' },
...
const sec2: MCQQuestion[] = [
  ...
  { id: 'hw7-s2-q6', type: 'mcq', question: 'Translate: שְׁמֹר', hebrew: 'שְׁמֹר', options: ['he kept', 'keep! (to one man)', 'keeping', 'to keep'], correctIndex: 1, explanation: 'CourseGuide Ch 18. The Qal Imperative 2ms of שָׁמַר, formed from the Imperfect תִּשְׁמֹר by removing the preformative.', category: 'imperative' },
...
const sec3: MCQQuestion[] = [
  ...
  { id: 'hw7-s3-q8', type: 'mcq', question: 'What happens to the Holem stem vowel of יִקְטֹל when a pronominal suffix is added?', hebrew: 'יִקְטֹל', options: ['it reduces to a vocal Shewa (יִקְטְל־)', 'it lengthens to Qamets', 'it becomes Shureq', 'it stays unchanged'], correctIndex: 0, explanation: 'CourseGuide Ch 19. The accent moves toward the suffix, so the stem vowel reduces: יִקְטְלֵנִי, "he will kill me." Expect reduction whenever a suffix pulls the accent forward.', category: 'verb-suffixes' },
