...
const sec1: MCQQuestion[] = [
  ...
  { id: 'hw9-s1-q3', type: 'mcq', question: 'Where does the REGULAR (non-consecutive) Imperfect normally stand?', options: ['always first in its clause', 'always at the end', 'not first — something normally precedes it', 'only in poetry'], correctIndex: 2, explanation: 'CourseGuide Ch 23. Position is a second, independent check on your parse: the regular forms are non-initial, and the consecutive ones open the clause.', category: 'syntax' },
...
const sec2: MCQQuestion[] = [
  ...
  { id: 'hw9-s2-q2', type: 'mcq', question: 'Why are some Niphal verbs translated actively, just like the Qal?', options: ['because the Niphal is really an active stem', 'because translators disagree about them', 'because their roots are common in the Niphal but unattested (or nearly so) in the Qal', 'because they are all reflexive'], correctIndex: 2, explanation: 'CourseGuide Ch 24. לָחַם is the standard example: rare in the Qal, so the Niphal נִלְחַם simply means "he fought."', category: 'niphal-strong' },
  { id: 'hw9-s2-q3', type: 'mcq', question: 'In which conjugations does the Niphal נ appear as a full consonant?', options: ['the Imperfect and Imperative', 'the Infinitive Construct only', 'nowhere', 'the Perfect, the Participle, and the Infinitive Absolute נִקְטוֹל'], correctIndex: 3, explanation: 'CourseGuide Ch 24. Everywhere else it assimilates into the first root consonant and survives only as a Daghesh Forte.', category: 'niphal-strong' },
...
const sec3: MCQQuestion[] = [
  ...
  { id: 'hw9-s3-q2', type: 'mcq', question: 'In III-ה Niphal verbs, what is affected?', options: ['every form is completely reshaped', 'only the stem vowels of the Perfect and Participle', 'only the Imperfect', 'nothing at all'], correctIndex: 1, explanation: 'CourseGuide Ch 25. The III-ה endings recur across the Qal and all the derived stems — learn them once and they keep paying off.', category: 'niphal-weak' },
