...
const ch35MemoryQuestions: PracticeQuestion[] = [
  ...
  { id: 'class12-memory-ch35-hitnabbe', prompt: 'Which root would you look up for this Hithpael form?', hebrew: 'הִתְנַבֵּא', transliteration: 'hitnabbe', options: ['נָבַט ("to look")', 'נָבָא ("to prophesy") — a III-א verb', 'בּוֹא ("to come in")', 'נָבַל ("to be foolish")'], correctIndex: 1, explanation: 'The נ here is a ROOT letter, not a Niphal prefix. The הִתְ in front and the doubled ב settle the stem.', category: 'ch35-memory' },
...
export const CLASS12_WORD_GROUPS: PracticeQuestionGroup[] = [
  wordGroup({ id: 'class12-word-palal', hebrew: 'פָּלַל', transliteration: 'palal', transliterationOptions: ['palal', 'pala', 'panah', 'patach'], transliterationCorrectIndex: 0, meaning: '(Hithpael) to pray, make intercession', meaningOptions: ['(Hithpael) to pray, make intercession', 'to be wonderful', 'to turn', 'to open'], meaningCorrectIndex: 0 }),
  ...
  wordGroup({ id: 'class12-word-chavah', hebrew: 'חָוָה', transliteration: 'chavah', transliterationOptions: ['chayah', 'chavah', 'chanah', 'charah'], transliterationCorrectIndex: 1, meaning: '(Hishtaphel) to bow down, worship', meaningOptions: ['to live', '(Hishtaphel) to bow down, worship', 'to camp', 'to burn with anger'], meaningCorrectIndex: 1 }),
